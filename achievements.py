...
class RallyAchievements():
    def __init__(self, car, main_menu, sand_track, grass_track, snow_track, forest_track, savannah_track, lake_track):
        ...
        create_achievement("Play the game!", self.play_the_game, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Race on Sand Track for the first time!", sand_achievements.play_sand_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Race on Grass Track for the first time!", grass_achievements.play_grass_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Race on Snow Track for the first time!", snow_achievements.play_snow_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Race on Forest Track for the first time!", forest_achievements.play_forest_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Race on Savannah Track for the first time!", savannah_achievements.play_savannah_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Race on Lake Track for the first time!", lake_achievements.play_lake_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Race against AI!", self.race_against_ai, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Play Multiplayer!", self.play_multiplayer, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Go to the Garage!", self.garage, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Play Time Trial!", self.time_trial, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Drift Gamemode!", self.unlock_drift, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Get under 20s on Sand Track!", sand_achievements.twenty_seconds_sand_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 17s on Sand Track!", sand_achievements.seventeen_seconds_sand_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 15s on Sand Track!", sand_achievements.fifteen_seconds_sand_track, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Get under 22s on Grass Track!", grass_achievements.twentytwo_seconds_grass_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 20s on Grass Track!", grass_achievements.twenty_seconds_grass_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 18s on Grass Track!", grass_achievements.eighteen_seconds_grass_track, icon = "confetti.png", ringtone = "unlock.ogg")
        
        create_achievement("Get under 40s on Snow Track!", snow_achievements.fourty_seconds_snow_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 36s on Snow Track!", snow_achievements.thirtysix_seconds_snow_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 33s on Snow Track!", snow_achievements.thirtythree_seconds_snow_track, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Get under 30s on Forest Track!", forest_achievements.thirty_seconds_forest_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 28s on Forest Track!", forest_achievements.twentyeight_seconds_forest_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 26s on Forest Track!", forest_achievements.twentysix_seconds_forest_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 25s on Forest Track!", forest_achievements.twentyfive_seconds_forest_track, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Get under 20s on Savannah Track!", savannah_achievements.twenty_seconds_savannah_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 18s on Savannah Track!", savannah_achievements.eighteen_seconds_savannah_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 16s on Savannah Track!", savannah_achievements.sixteen_seconds_savannah_track, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Get under 60s on Lake Track!", lake_achievements.sixty_seconds_lake_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 55s on Lake Track!", lake_achievements.fiftyfive_seconds_lake_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 50s on Lake Track!", lake_achievements.fifty_seconds_lake_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Get under 47s on Lake Track!", lake_achievements.fourtyseven_seconds_lake_track, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Muscle Car!", car_achievements.unlock_muscle_car, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Limo!", car_achievements.unlock_limo, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Lorry!", car_achievements.unlock_lorry, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Hatchback!", car_achievements.unlock_hatchback, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Rally Car!", car_achievements.unlock_rally, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Sports Car Green!", car_achievements.sports_green, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Sports Car Orange!", car_achievements.sports_orange, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Sports Car White!", car_achievements.sports_white, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Sports Car Black!", car_achievements.sports_black, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Muscle Car Red!", car_achievements.muscle_red, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Muscle Car Blue!", car_achievements.muscle_blue, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Muscle Car Green!", car_achievements.muscle_green, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Muscle Car White!", car_achievements.muscle_white, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Muscle Car Black!", car_achievements.muscle_black, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Limo Red!", car_achievements.limo_red, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Limo Blue!", car_achievements.limo_blue, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Limo Green!", car_achievements.limo_green, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Limo White!", car_achievements.limo_white, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Limo Orange!", car_achievements.limo_orange, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Lorry Red!", car_achievements.lorry_red, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Lorry Blue!", car_achievements.lorry_blue, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Lorry Green!", car_achievements.lorry_green, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Lorry Orange!", car_achievements.lorry_orange, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Lorry Black!", car_achievements.lorry_black, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Hatchback Red!", car_achievements.hatchback_red, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Hatchback Blue!", car_achievements.hatchback_blue, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Hatchback White!", car_achievements.hatchback_white, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Hatchback Orange!", car_achievements.hatchback_orange, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Hatchback Black!", car_achievements.hatchback_black, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Rally Car White!", car_achievements.rally_white, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Rally Car Blue!", car_achievements.rally_blue, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Rally Car Green!", car_achievements.rally_green, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Rally Car Orange!", car_achievements.rally_orange, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Rally Car Black!", car_achievements.rally_black, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Beat Mandaw in Sand Track!", self.beat_mandaw_in_sand_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Beat Mandaw in Grass Track!", self.beat_mandaw_in_grass_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Beat Mandaw in Snow Track!", self.beat_mandaw_in_snow_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Beat Mandaw in Forest Track!", self.beat_mandaw_in_forest_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Beat Mandaw in Savannah Track!", self.beat_mandaw_in_savannah_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Beat Mandaw in Lake Track!", self.beat_mandaw_in_lake_track, icon = "confetti.png", ringtone = "unlock.ogg")
        
        create_achievement("Beat Mandaw in Every Track!", self.beat_mandaw_in_everything, icon = "confetti.png", ringtone = "unlock.ogg")

        create_achievement("Unlock Grass Track!", self.unlock_grass_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Snow Track!", self.unlock_snow_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Forest Track!", self.unlock_forest_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Savannah Track!", self.unlock_savannah_track, icon = "confetti.png", ringtone = "unlock.ogg")
        create_achievement("Unlock Lake Track!", self.unlock_lake_track, icon = "confetti.png", ringtone = "unlock.ogg")
