...
class MainMenu(Entity):
    def __init__(self, car, ai_list, sand_track, grass_track, snow_track, forest_track, savannah_track, lake_track):
        ...
        self.click = Audio("click.wav", loop=False, autoplay=False, volume = 1)
        ...
        quit_text = Text("Are you sure you want to quit?", scale = 1.5, line_height = 2, x = 0, origin = (0, 0), y = 0.2, parent = self.quit_menu)
        ...
        running = Text(text = "Running server...", scale = 1.5, line_height = 2, x = 0, origin = (0, 0), y = 0.2, parent = self.created_server_menu)
        ...
        unlocked_text = Text("Get Less Than 20 seconds on Sand Track to Unlock Grass Track", scale = 1.5, color = color.orange, line_height = 2, origin = (0, 0), y = -0.1, parent = self.maps_menu)
        unlocked_text.disable()

        highscore_text = Text("", scale = 1.2, color = color.white, line_height = 2, origin = (0, 0), y = -0.07, parent = self.maps_menu)
        highscore_text.disable()
        ...
        self.leaderboard_title = Text("Leaderboard", color = color.gold, scale = 5, line_height = 2, origin = (0, 0), y = 0.4, parent = self.leaderboard_background)
        
        self.leaderboard_01 = Text(text = "", color = color.hex("#CCCCCC"), scale = 3, line_height = 2, x = 0, origin = (0, 0), y = 0.2, parent = self.leaderboard_background)
        self.leaderboard_02 = Text(text = "", color = color.hex("#CCCCCC"), scale = 3, line_height = 2, x = 0, origin = (0, 0), y = 0.1, parent = self.leaderboard_background)
        self.leaderboard_03 = Text(text = "", color = color.hex("#CCCCCC"), scale = 3, line_height = 2, x = 0, origin = (0, 0), y = 0, parent = self.leaderboard_background)
        self.leaderboard_04 = Text(text = "", color = color.hex("#CCCCCC"), scale = 3, line_height = 2, x = 0, origin = (0, 0), y = -0.1, parent = self.leaderboard_background)
        self.leaderboard_05 = Text(text = "", color = color.hex("#CCCCCC"), scale = 3, line_height = 2, x = 0, origin = (0, 0), y = -0.2, parent = self.leaderboard_background)
        ...
        self.garage_name_text = Text("Surfin Bird", scale = 1.5, color = color.white, line_height = 2, origin = (0, 0), x = -0.5, y = -0.4, parent = self.garage_menu)
        self.garage_name_text.disable()

        self.garage_unlocked_text = Text("Beat Mandaw in Every Track", scale = 1.5, color = color.orange, line_height = 2, origin = (0, 0), y = 0.3, parent = self.garage_menu)
        ...
        # Server Error Log
        self.connected = Text(text = "Connected to server!", scale = 1.5, color = color.hex("4dff4d"), line_height = 2, x = -0.55, origin = (0, 0), y = 0.45, parent = camera.ui)
        self.not_connected = Text(text = "Not connected to server...", scale = 1.5, color = color.hex("FF2E2E"), line_height = 2, x = -0.55, origin = (0, 0), y = 0.45, parent = camera.ui)
